...
TEST(Vec, CrossProductAntiCommutative) {
    const Vec3f a(1.f, 2.f, 3.f);
    const Vec3f b(4.f, 5.f, 6.f);
    const Vec3f ab = cross(a, b);
    const Vec3f ba = cross(b, a);
