...
|------|---------|-------------|----------|--------|
| 1 — Research | [tinyrenderer](./tinyrenderer/) | Software renderer following [haqr.eu/tinyrenderer](https://haqr.eu/tinyrenderer/) | C++23 | Lessons 1–7 done, Lesson 8 (tangent space normal maps) next |
