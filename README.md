...
|------|---------|-------------|----------|--------|
| 1 — Research | [tinyrenderer](./tinyrenderer/) | Software renderer following [haqr.eu/tinyrenderer](https://haqr.eu/tinyrenderer/) | C++23 | Lessons 1–6 done, Lesson 7 (textures) next |
